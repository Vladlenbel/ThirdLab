...
import Model.PointStepX;
import Model.PointStepY;
...
public class Graphic extends JPanel {
    ...
    private Color GRAPH_COLOR = Color.RED;
    ...
    public Graphic(List<Point> points) {
        this.points = points;
       // this.points.sort(new PointStepX());
        this.zoom = 0.5;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (points.size() > 0) {
            //double maxNumberOfElements = findStep((int) Collections.max(points, new PointStepX()).getX());
            //double maxTime = findStep((int) Collections.max(points, new PointStepY()).getY());
           ...
           // double yScale = (((double) getHeight() - 2 * border_gap) / maxTime);
            ...
            java.util.List<Point> zoomedPointsList = new ArrayList<>();
